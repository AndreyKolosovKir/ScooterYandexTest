...
public class BasePage {
    ...
    //генератоор рандомных чисенл
    public Integer randomizerNumber(int maxValue){
        int minValue = 1;
        int randomValue = minValue + (int) (Math.random() * (maxValue - minValue + 1));
        return randomValue;
    }

    //выбор числа по текущей дате (день)
    public Integer returnToday (){
    ...
    public void moveAroundThePage (WebElement element){
